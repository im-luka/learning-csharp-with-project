...
namespace AI_Hospital.model
{
    class Person
    {
        ...
        public Person(string firstName, string lastName, int age, County county, Disease disease, List<Person> contactedPersonsList)
        {
        ...
        public class PersonBuilder
        {
            ...
            public Person Build()
            {
                Person person = new Person(this.firstName, this.lastName, this.age, this.county, this.disease, this.contactedPersonsList);
                return person;
            }
        }
    }
